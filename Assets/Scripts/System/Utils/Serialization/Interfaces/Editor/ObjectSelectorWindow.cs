...
using System.Linq;
using System.Text;
using NavySpade.Modules.Utils.Serialization.Interfaces.Editor.UIElements;
using UnityEditor;
...
namespace NavySpade.Modules.Utils.Serialization.Interfaces.Editor
{
	internal class ObjectSelectorWindow : EditorWindow
	{
		...
		public static void Show(SerializedProperty property, System.Action<Object> onSelectionChanged, System.Action<Object, bool> onSelectorClosed, ObjectSelectorFilter filter)
		{
			if (Instance == null)
			{
	...
	public class ObjectSelectorFilter
	{
		...
		public ObjectSelectorFilter(string assetSearchFilter, System.Func<Object, bool> sceneFilterCallback)
		{
